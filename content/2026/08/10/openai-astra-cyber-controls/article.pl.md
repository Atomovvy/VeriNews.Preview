...
7 sierpnia OpenAI poinformowało, że wstępne wewnętrzne testy nadchodzącego modelu Astra wykazały na tyle duży postęp w cyberbezpieczeństwie, że firma nie może wykluczyć poziomu `Critical` według własnego Preparedness Framework. OpenAI jednocześnie wstrzymuje te wewnętrzne aktywności związane z Astrą, które nie spełniają nowych, zaostrzonych wymagań bezpieczeństwa.
...
- OpenAI podało, że po wstępnych ewaluacjach nie może wykluczyć poziomu `Critical` w obszarze cyber.
- Firma wdraża mocniejsze zabezpieczenia i wstrzymuje aktywności z Astrą, które jeszcze nie spełniają nowych wymagań.
- OpenAI podało, że Astra nie była modelem wykorzystanym w incydencie z Hugging Face.
...
- pełne wyniki niezależnych testów Astry,
...
- [OpenAI — Responding to the next frontier of critical cyber capabilities](https://openai.com/index/responding-next-frontier-critical-cyber-capabilities/) — źródło pierwotne.
- [Axios — OpenAI slows release of Astra model citing cyber capabilities](https://www.axios.com/2026/08/07/openai-astra-model-delay-cybersecurity-risks) — niezależna relacja.
- [OpenAI — Hugging Face model evaluation security incident](https://openai.com/index/hugging-face-model-evaluation-security-incident/) — kontekst wcześniejszego incydentu.
