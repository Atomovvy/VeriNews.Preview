...
The reader controls under review are local-only age selection, unreviewed-material disclosure, per-item reveal, shared light/dark theme and PL/EN switching.
